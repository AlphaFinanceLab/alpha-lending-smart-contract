...
const MockLendingPoolSplitRewards = artifacts.require("./MockLendingPoolSplitRewards.sol");
...
contract("Split Reward", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    lendingInstance = await MockLendingPoolSplitRewards.new(alTokenDeployer.address);
